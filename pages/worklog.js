    ...
    <Nav activeLink={"My Worklog"}>
      <FadeIn>
        <div className="flex flex-col items-center mb-24">
          <h1 className="font-body text-8xl tracking-wide text-center mt-4 sm:mt-8 font-medium">
            My Worklog
          </h1>
          <div className="mt-4 sm:mt-6 sm:w-3/4 md:w-1/2 w-full justify-self-center text-center">
            <p className=" text-lg">
              All of my biggest projects, ever made, all in one place. For the
              rest of my design work, check out my{" "}
              <a
